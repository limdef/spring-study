...
var _ = calculator.GoUnusedProtection__
...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  i32 subtract(i32 num1, i32 num2)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := calculator.NewCalculatorClient(thrift.NewTStandardClient(iprot, oprot))
